...
export const nl = {
  ...
  portal: {
    ...
    newLinkEmailLabel: "Je e-mailadres",
    newLinkSend: "Vraag een nieuwe link",
    newLinkSending: "Bezig…",
    newLinkSent: "Verstuurd — check je inbox voor een nieuwe link.",
...
export const en: Copy = {
  ...
  portal: {
    ...
    newLinkEmailLabel: "Your email address",
    newLinkSend: "Request a new link",
    newLinkSending: "Sending…",
    newLinkSent: "Sent — check your inbox for a new link.",
