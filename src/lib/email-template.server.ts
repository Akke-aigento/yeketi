...
function button(btn: EmailButton): string {
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
      <tr><td align="center" bgcolor="#B0832C" style="border:1px solid #221F1B;">
        <!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->
        <a href="${escapeHtml(btn.url)}" style="display:inline-block;background:#B0832C;color:#FFFFFF;text-decoration:none;padding:14px 30px;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;letter-spacing:0.22em;text-transform:uppercase;line-height:1;">${escapeHtml(btn.label)}</a>
        <!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->
      </td></tr>
    </table>
  `;
...
export function renderEmail(opts: EmailLayoutOpts): string {
  ...
  const body = opts.bodyHtml ? `<div style="font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.7;color:#4A453E;">${opts.bodyHtml}</div>` : "";
